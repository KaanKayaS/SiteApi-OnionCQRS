...
namespace SiteApi.Mapper.AutoMapper
{
    public class Mapper : Application.Interfaces.AutoMapper.IMapper
    {
        ...
        public TDestination Map<TDestination, TSource>(IList<object> source, string? ignore = null)
        {
            Config<TDestination,IList<object>>(5, ignore);

            return (TDestination)MapperContainer.Map<IList<TDestination>>(source);
        }
